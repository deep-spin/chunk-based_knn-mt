...
def add_datastore_args(parser):
    ...
    group.add_argument("--chunk_size", default=1, type=int)
    ...
    group.add_argument("--save_decoder_states", action='store_true')
    group.add_argument("--pca_decoder_states", default=0, type=int)
    return parser
