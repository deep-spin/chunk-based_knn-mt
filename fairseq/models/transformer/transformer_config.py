...
class TransformerConfig(FairseqDataclass):
    ...
    datastore_chunk_size: int = field(default=0)
    simplistic: bool = field(default=False)
    unsupervised: bool = field(default=False)
    supervised: bool = field(default=False)
    training_supervised: bool = field(default=False)
    all_neighbours: bool = field(default=False)
    keep_previous_neighbours: bool = field(default=False)
    previous_neighbours_threshold: int = field(default=0)
    use_local_faiss: bool = field(default=False)
    retrieval_steps: str = field(default='chunk_size')
    retrieval_steps_max: int = field(default=8)
    retrieval_steps_min: int = field(default=2)
    retrieval_threshold: int = field(default=0)
    on_the_fly: bool = field(default=False)
    on_the_fly_n_updates: int = field(default=1000)
    on_the_fly_reindexing: bool = field(default=False)
    on_the_fly_reindexing_interval: int = field(default=1000)
    on_the_fly_keys_size: int = field(default=1)
    on_the_fly_finetuning: bool = field(default=False)
    on_the_fly_finetuning_interval: int = field(default=1000)
    ...
    knn_lambda_value_2: float = field(default=0)
    knn_temperature_value_2: float = field(default=0)
